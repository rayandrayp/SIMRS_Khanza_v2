 ...
 * @author dosen
 */
public final class DlgCariPetugasLab extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariPetugasLab(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPetugasLab dialog = new DlgCariPetugasLab(new javax.swing.JFrame(), true);
    ...
    private void tampil() {  
        ...
        try{
            file=new File("./cache/petugasLab.iyem");
            file.createNewFile();
