...
public class DlgBilingRalan extends javax.swing.JDialog {
    ...
    private int i,j,r,cek,row2,countbayar=0,z=0,jml=0;
...
//                    2    "Obat & BHP ",
//                    3    ":",
//                    4    rsobatlangsung.getDouble("besar_tagihan"),
//                    5    1,
//                    6    0,
//                    7    rsobatlangsung.getDouble("besar_tagihan"),
//                    8    "Obat"});
...
//                        subttl=subttl+rscariobat.getDouble("total")+rscariobat.getDouble("tambahan");
    ...
    public void isKembali(){
        ...
        //hitung PPN
        besarppn = Math.round(ttl * (ppn/100));
//        System.out.println("ttl "+String.valueOf(ttl));
//        System.out.println("besarppn awal "+besarppn);
