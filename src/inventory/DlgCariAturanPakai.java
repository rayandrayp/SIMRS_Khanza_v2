        ...
        try{  
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    iyem=iyem+"{\"AturanPakai\":\""+rs.getString(1)+"\",\"Signa\":\""+rs.getString(2)+"\"},";
                }
            } catch (Exception e) {
            ...
            if(response.isArray()){
                for(JsonNode list:response){
                    if(list.path("AturanPakai").asText().toLowerCase().contains(TCari.getText().toLowerCase()) 
                            || list.path("Signa").asText().toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{
                            list.path("AturanPakai").asText(),list.path("Signa").asText()
                        });
                    }
                }
            }
