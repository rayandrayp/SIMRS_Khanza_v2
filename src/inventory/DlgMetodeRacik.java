...
public final class DlgMetodeRacik extends javax.swing.JDialog {
    ...
    public DlgMetodeRacik(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"P","Kode","Metode Racik","Signa"};
    ...
    private void initComponents() {
        ...
        panelisi4.add(Nm);
        Nm.setBounds(270, 10, 220, 23);

        label37.setText("Metode Racik :");
        label37.setName("label37"); // NOI18N
        label37.setPreferredSize(new java.awt.Dimension(35, 23));
        panelisi4.add(label37);
        label37.setBounds(180, 10, 80, 23);

        signa.setHighlighter(null);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Sequel.menyimpan("metode_racik","'"+Kd.getText()+"','"+Nm.getText()+"','"+signa.getText()+"'","Kode Racik");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
...
private void NmKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmKeyPressed
   Valid.pindah(evt,Kd,BtnSimpan);
    ...
    private void signaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_signaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_signaKeyPressed
    ...
    */
    ...
    private void tampil() {
        ...
        try{  
            ps=koneksi.prepareStatement("select kd_racik,nm_racik,signa  "+
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            signa.setText(tbKamar.getValueAt(row,3).toString());
        }
    }
