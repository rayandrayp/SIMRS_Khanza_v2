...
public class DlgAturanPakai extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Signa :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass7.add(jLabel4);
        jLabel4.setBounds(470, 10, 40, 23);
        ...
        panelGlass7.add(Signa);
        Signa.setBounds(520, 10, 130, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nama.getText().trim().equals("")){
            Valid.textKosong(Nama,"Aturan Pakai");
        }else if(Signa.getText().trim().equals("")){
            Valid.textKosong(Signa,"Signa");
        }else {
            Sequel.menyimpan("master_aturan_pakai","'"+Nama.getText()+"','"+Signa.getText()+"'","Aturan Pakai");
            tampil();
            emptTeks();
        }
    ...
    */
    ...
    private void getData() {
        if(tbkabupaten.getSelectedRow()!= -1){
            ...
            Signa.setText(tbkabupaten.getValueAt(tbkabupaten.getSelectedRow(),1).toString());
        }
    }
