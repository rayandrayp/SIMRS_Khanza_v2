...
public final class DlgCariMetodeRacik extends javax.swing.JDialog {
    ...
    public DlgCariMetodeRacik(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.","Kode","Metode Racik","Signa"};        
        ...
        try{  
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    iyem=iyem+"{\"KodeRacik\":\""+rs.getString(1)+"\",\"NamaRacik\":\""+rs.getString(2)+"\",\"Signa\":\""+rs.getString(3)+"\"},";
                    i++;
                }
            } catch (Exception e) {
                ...
                for(JsonNode list:response){
                    if(list.path("NamaRacik").asText().toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{
                            i+"",list.path("KodeRacik").asText(),list.path("NamaRacik").asText(),list.path("Signa").asText()
                        });
                        i++;
                    }
                }
