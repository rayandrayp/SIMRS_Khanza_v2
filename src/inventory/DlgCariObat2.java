...
public final class DlgCariObat2 extends javax.swing.JDialog {
    ...
    public DlgCariObat2(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Aturan Pakai","Kategori","Golongan","No.Batch","No.Faktur","Kadaluarsa","Kemoterapi"
        }){
...
//                                            double jumlah_kronis = jumlah_obat - jumlah_nonkronis;
                                            ...
                                            simpan_kronis = Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",17,new String[]{
                                                            Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+detik_kronis,TNoRw.getText(),tbObat.getValueAt(i,2).toString(),tbObat.getValueAt(i,12).toString(),
                                                            ...
                                                            "Ranap",kdgudang.getText(),tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString(), "1", ""+jumlah_obat,obat_kemo
                                                        });
                                            
                                            //(jumlah_nonkronis/carikapasitas.getDouble(1))
                                            simpan_nonkronis = Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",17,new String[]{
                                                            Valid.SetTgl(DTPTgl.getSelectedItem()+""),jam_nonkronis+":"+menit_nonkronis+":"+detik_nonkronis,TNoRw.getText(),tbObat.getValueAt(i,2).toString(),tbObat.getValueAt(i,12).toString(),
                                                            tbObat.getValueAt(i,6).toString(),""+jumlah_nonkronis,
                                                            tbObat.getValueAt(i,8).toString(),tbObat.getValueAt(i,9).toString(),""+Math.round(
                                                                Double.parseDouble(tbObat.getValueAt(i,8).toString())+
                                                                Double.parseDouble(tbObat.getValueAt(i,9).toString())+
                                                                (Double.parseDouble(tbObat.getValueAt(i,6).toString())*jumlah_nonkronis)),
                                                            "Ranap",kdgudang.getText(),tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString(), "0", "0",obat_kemo
                                                        });
                                        } else {
                                            ...
                                            simpan_nonkronis = Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",17,new String[]{
                                                            ...
                                                            "Ranap",kdgudang.getText(),tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString(), "0", ""+jumlah_obat,obat_kemo
                                                        });
                                            simpan_kronis = true;
                                        }
                                        ...
                                        if(simpan_kronis==true && simpan_nonkronis==true){
                                            ...
                                            ttljual=ttljual+Math.round(Double.parseDouble(tbObat.getValueAt(i,8).toString())+
                                                    Double.parseDouble(tbObat.getValueAt(i,9).toString())+(Double.parseDouble(tbObat.getValueAt(i,6).toString())*jumlah_obat));
                                            ttlhpp=ttlhpp+Math.round(Double.parseDouble(tbObat.getValueAt(i,12).toString())*jumlah_obat);
...
//                                            "Ranap",kdgudang.getText(),tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString(), "0"+""+Double.parseDouble(tbObat.getValueAt(i,1).toString())
//                                        })==true){    
                                            ttljual=ttljual+Math.round(Double.parseDouble(tbObat.getValueAt(i,8).toString())+
                                                    Double.parseDouble(tbObat.getValueAt(i,9).toString())+(Double.parseDouble(tbObat.getValueAt(i,6).toString())*jumlah_obat));
                                            ttlhpp=ttlhpp+Math.round(Double.parseDouble(tbObat.getValueAt(i,12).toString())*jumlah_obat);
...
//                                    System.out.println("save detail_pemberian_obat berhasil");
                                    ttljual=ttljual+Math.round(Double.parseDouble(tbObat.getValueAt(i,8).toString())+
                                            Double.parseDouble(tbObat.getValueAt(i,9).toString())+(Double.parseDouble(tbObat.getValueAt(i,6).toString())*jumlah_obat));
                                    ttlhpp=ttlhpp+Math.round(Double.parseDouble(tbObat.getValueAt(i,12).toString())*jumlah_obat);
//                                    System.out.println("sipman aturan pakai " + tbObat.getValueAt(i,13).toString().equals(""));
                                    if(!tbObat.getValueAt(i,13).toString().equals("")){
                                        Sequel.menyimpan("aturan_pakai","?,?,?,?,?",5,new String[]{
                                            Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),TNoRw.getText(),tbObat.getValueAt(i,2).toString(),tbObat.getValueAt(i,13).toString()
                                        });
...
//                                        System.out.println("track obat ");
                                        Trackobat.catatRiwayat(tbObat.getValueAt(i,2).toString(),0,Double.parseDouble(tbObat.getValueAt(i,1).toString()),"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan","","",TNoRw.getText()+" "+TNoRM.getText()+" "+TPasien.getText());
//                                        System.out.println("simpan gudangbarang"); 
                                        Sequel.menyimpan("gudangbarang","'"+tbObat.getValueAt(i,2).toString()+"','"+kdgudang.getText()+"','-"+Double.parseDouble(tbObat.getValueAt(i,1).toString())+"','',''", 
                                                 "stok=stok-'"+Double.parseDouble(tbObat.getValueAt(i,1).toString())+"'","kode_brng='"+tbObat.getValueAt(i,2).toString()+"' and kd_bangsal='"+kdgudang.getText()+"' and no_batch='' and no_faktur=''");  
//                                        System.out.println("gudangbarang sukses");
                                    }
...
//                                    System.out.println("paket HD " + tbObat.getValueAt(i,2).equals("B000009066"));
                                    ...
                                    //end of save data paket HD
//                                    System.out.println("aktifpcare "+aktifpcare);
                                    if(aktifpcare.equals("yes")){
                                        arrSplit = tbObat.getValueAt(i,13).toString().toLowerCase().split("x");
                                        signa1="1";
                                        try {
                            ...
                            if(Sequel.menyimpantf2("detail_obat_racikan","?,?,?,?,?","Data",5,new String[]{
                               ...
                               tbDetailObatRacikan.getValueAt(i,0).toString(),tbDetailObatRacikan.getValueAt(i,1).toString()
                                ...
                                if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",17,new String[]{
                                    ...
                                    "Ranap",kdgudang.getText(),tbDetailObatRacikan.getValueAt(i,16).toString(),tbDetailObatRacikan.getValueAt(i,17).toString(),"0",""+Double.parseDouble(tbDetailObatRacikan.getValueAt(i,10).toString()),"0"
                                })==true){
...
//                    System.out.println("1 sukses? "+sukses);
                    if(sukses==true){
...
//                    System.out.println("2 sukses? "+sukses);
                    if(sukses==true){
                        Sequel.Commit();
                        for(i=0;i<tbObat.getRowCount();i++){
...
//                    System.out.println("3 sukses? "+sukses);                        
                    if(sukses==true){
    ...
    public void tampil() {   
        ...
        for(i=0;i<tbObat.getRowCount();i++){
            if(!tbObat.getValueAt(i,1).toString().equals("")){
                ...
                pilihKemo[jml]=Boolean.parseBoolean(tbObat.getValueAt(i,19).toString());  
                jml++;
            }
        }
        ...
        for(i=0;i<jml;i++){
            tabMode.addRow(new Object[] {pilih[i],jumlah[i],kodebarang[i],namabarang[i],
               ...
               beli[i],aturan[i],kategori[i],golongan[i],nobatch[i],nofaktur[i],kadaluarsa[i],pilihKemo[i]
            });
        }
            ...
            if(kenaikan>0){
                if(aktifkanbatch.equals("yes")){
                    ...
                    psobat=koneksi.prepareStatement(
                            sql+" where gudangbarang.kd_bangsal=? and databarang.kode_brng like ? or "+
                        " gudangbarang.kd_bangsal=? and databarang.nama_brng like ? or "+
                        " gudangbarang.kd_bangsal=? and kategori_barang.nama like ? or "+
                        " gudangbarang.kd_bangsal=? and golongan_barang.nama like ? or "+
                        " gudangbarang.kd_bangsal=? and data_batch.no_batch like ? or "+
                        " gudangbarang.kd_bangsal=? and data_batch.no_faktur like ? or "+
                        " gudangbarang.kd_bangsal=? and jenis.nama like ? order by data_batch.tgl_kadaluarsa asc");
...
//                        " gudangbarang.stok>0 and gudangbarang.kd_bangsal=? and jenis.nama like ? order by data_batch.tgl_kadaluarsa asc");
                    ...
                    psobat=koneksi.prepareStatement(
                        sql+" where gudangbarang.no_batch='' and gudangbarang.no_faktur='' and gudangbarang.kd_bangsal=? and databarang.status='1' and databarang.kode_brng like ? or "+
                        ...
                        " gudangbarang.no_batch='' and gudangbarang.no_faktur='' and gudangbarang.kd_bangsal=? and databarang.status='1' and kategori_barang.nama like ? or "+
                        " gudangbarang.no_batch='' and gudangbarang.no_faktur='' and gudangbarang.kd_bangsal=? and databarang.status='1' and golongan_barang.nama like ? or "+
...
//                        " gudangbarang.no_batch='' and gudangbarang.no_faktur='' and gudangbarang.stok>0 and gudangbarang.kd_bangsal=? and databarang.status='1' and jenis.nama like ? order by databarang.nama_brng");
                ...
                if(aktifkanbatch.equals("yes")){
                    ...
                    psobat=koneksi.prepareStatement(
                        ...
                        " gudangbarang.kd_bangsal=? and databarang.nama_brng like ? or "+
                        " gudangbarang.kd_bangsal=? and kategori_barang.nama like ? or "+
                        " and gudangbarang.kd_bangsal=? and golongan_barang.nama like ? or "+
                        " and gudangbarang.kd_bangsal=? and data_batch.no_batch like ? or "+
                        " and gudangbarang.kd_bangsal=? and data_batch.no_faktur like ? or "+
                        " and gudangbarang.kd_bangsal=? and jenis.nama like ? order by data_batch.tgl_kadaluarsa asc");
//                    psobat=koneksi.prepareStatement(
//                        sql+" where gudangbarang.stok>0 and gudangbarang.kd_bangsal=? and databarang.kode_brng like ? or "+
//                        " gudangbarang.stok>0 and gudangbarang.kd_bangsal=? and databarang.nama_brng like ? or "+
//                        " gudangbarang.stok>0 and gudangbarang.kd_bangsal=? and kategori_barang.nama like ? or "+
...
//                        " gudangbarang.stok>0 and gudangbarang.kd_bangsal=? and jenis.nama like ? order by data_batch.tgl_kadaluarsa asc");
                    ...
                    if(aktifpcare.equals("yes")){
                        sql="select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,databarang.kelas1,"+
                            " databarang.kelas2,databarang.kelas3,databarang.utama,databarang.vip,databarang.vvip,databarang.beliluar,databarang.karyawan,FLOOR(gudangbarang.stok) AS stok,"+
...
//                        " gudangbarang.no_batch='' and gudangbarang.no_faktur='' and gudangbarang.stok>0 and gudangbarang.kd_bangsal=? and databarang.status='1' and jenis.nama like ? order by databarang.nama_brng");
                ...
                if(aktifkanbatch.equals("yes")){
                    ...
                    psobat=koneksi.prepareStatement(
                        ...
                        " gudangbarang.kd_bangsal=? and data_batch.no_batch like ? or "+
                        " gudangbarang.kd_bangsal=? and data_batch.no_faktur like ? or "+
                        " gudangbarang.kd_bangsal=? and jenis.nama like ? order by data_batch.tgl_kadaluarsa");
//                    psobat=koneksi.prepareStatement(
//                        sql+" where gudangbarang.stok>0 and gudangbarang.kd_bangsal=? and databarang.kode_brng like ? or "+
//                        " gudangbarang.stok>0 and gudangbarang.kd_bangsal=? and databarang.nama_brng like ? or "+
//                        " gudangbarang.stok>0 and gudangbarang.kd_bangsal=? and kategori_barang.nama like ? or "+
...
//                        " gudangbarang.stok>0 and gudangbarang.kd_bangsal=? and jenis.nama like ? order by data_batch.tgl_kadaluarsa");
                    ...
                    if(aktifpcare.equals("yes")){
                        sql="select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,databarang.kelas1,databarang.kelas2,databarang.kelas3,"+
                            " databarang.utama,databarang.vip,databarang.vvip,databarang.beliluar,databarang.karyawan,databarang."+hppfarmasi+" as dasar,FLOOR(gudangbarang.stok) AS stok,"+
                            " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,kategori_barang.nama as kategori,golongan_barang.nama as golongan,databarang.kapasitas  "+
                            " from databarang inner join jenis on databarang.kdjns=jenis.kdjns "+
                            " inner join industrifarmasi on industrifarmasi.kode_industri=databarang.kode_industri "+
                            " inner join golongan_barang on databarang.kode_golongan=golongan_barang.kode "+
                    ...
                    try {
                        ...
                        while(rsobat.next()){
                            ...
                            psbatch=koneksi.prepareStatement(
                                ...
                                "data_batch.jualbebas, data_batch.karyawan, data_batch.jumlahbeli, FLOOR(gudangbarang.stok) AS stok,data_batch."+hppfarmasi+" as dasar from data_batch inner join gudangbarang where "+
                                "data_batch.kode_brng=? and gudangbarang.kd_bangsal=? order by data_batch.tgl_kadaluarsa desc limit 1");
//                            psbatch=koneksi.prepareStatement(
//                                "select data_batch.no_batch, data_batch.kode_brng, data_batch.tgl_beli, data_batch.tgl_kadaluarsa, data_batch.asal, data_batch.no_faktur, "+
//                                "data_batch.h_beli, data_batch.ralan, data_batch.kelas1, data_batch.kelas2, data_batch.kelas3, data_batch.utama, data_batch.vip, data_batch.vvip, data_batch.beliluar, "+
