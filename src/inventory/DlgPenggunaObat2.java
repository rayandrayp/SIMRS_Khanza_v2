...
public class DlgPenggunaObat2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPenggunaObat2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row={"Kode Barang","Nama Barang","Jml","Satuan"};
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            for(int r=0;r<row;r++){  
                Sequel.menyimpan("temporary","'0','"+ //"+r+"
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPenggunaObat2 dialog = new DlgPenggunaObat2(new javax.swing.JFrame(), true);
