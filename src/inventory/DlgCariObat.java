...
public final class DlgCariObat extends javax.swing.JDialog {
    ...
    private boolean[] pilih,pilihKemo; 
    ...
    public DlgCariObat(java.awt.Frame parent, boolean modal) {
        ...
        tabModeobat=new DefaultTableModel(null,new Object[]{
                ...
                "H.Beli","Kategori","Golongan","No.Batch","No.Faktur","Kadaluarsa","Kemoterapi"
            }){
        ...
        if(TNoRw.getText().trim().equals("")){
            ...
            if (reply == JOptionPane.YES_OPTION) {
                try {  
                    ...
                    sukses=true;
                    ttlhpp=0;ttljual=0;
                    ArrayList<String[]> paketHD = new ArrayList<String[]>(); //paketHD single use karena hanya 15
                    //referensi new String[] {[kode_brng], [jumlah]} //nama barang #nomor di list
                    paketHD.add(new String[] {"G000009885", "2"});//Alkohol Swab #1
                    paketHD.add(new String[] {"G000009899", "1"});//AV Fistula 1.25 inch panjang #2
                    paketHD.add(new String[] {"G000009898", "1"});//AV Fistula 1 inch pendek #2
                    paketHD.add(new String[] {"G000010139", "1"});//SET ART-VEN BLOOD TUBING SET #3
                    paketHD.add(new String[] {"G000010191", "2"});//surgical unicorn glove #4
                    paketHD.add(new String[] {"G000010030", "1"});//Infus Set Serenity #5
                    paketHD.add(new String[] {"G000010053", "0.01"});//kassa rol nasaco #6   1 roll/100 pasien
                    paketHD.add(new String[] {"G000010070", "1"});//masker karet #7
                    paketHD.add(new String[] {"G000010066", "0.2"});//plester leukoplast #8
                    paketHD.add(new String[] {"G000009952", "1"});//spuit 10cc #9
                    paketHD.add(new String[] {"G000009954", "1"});//spuit 20cc #10
                    paketHD.add(new String[] {"G000009875", "1"});//acid a sol/acid concentrate  #12
                    paketHD.add(new String[] {"G000009905", "1"});//bicnat sol #13
                    paketHD.add(new String[] {"G000009969", "0.17"});//dialyser #14
                    paketHD.add(new String[] {"B000013026", "0.5"});//heparin/ clostatop inj #15
//                    System.out.println("size paket HD awal " + paketHD.size());
...
//                                obat_kemo = (tbObat.getValueAt(i,19).toString().equals("true")) ? "1":"0";
                                ...
                                double jumlah_obat = Double.parseDouble(tbObat.getValueAt(i,1).toString());
//                                pscarikapasitas= koneksi.prepareStatement("select IFNULL(kapasitas,1) from databarang where kode_brng=?");
                                pscarikapasitas= koneksi.prepareStatement("select CASE kapasitas WHEN 0 THEN 1 ELSE kapasitas END from databarang where kode_brng=?");
                                try {
                                    pscarikapasitas.setString(1,tbObat.getValueAt(i,2).toString());
                                    carikapasitas=pscarikapasitas.executeQuery();
                                    if(carikapasitas.next()){ //jika ada kapasitas
                                        boolean simpan_kronis = false;
                                        boolean simpan_nonkronis = false;
...
//                                            double jumlah_kronis = jumlah_obat - jumlah_nonkronis;
                                            ...
                                            String jam_nonkronis = cmbJam.getSelectedItem().toString();
                                                                                        
                                            //code untuk menambahkan waktu, untuk membedakan obat kronis dan nonkronis
                                            if(Integer.parseInt(cmbDtk.getSelectedItem().toString())+1 == 60){
                                                menit_nonkronis = String.valueOf(Integer.parseInt(cmbMnt.getSelectedItem().toString())+1);
                                                detik_nonkronis = "00";
                                                //System.out.println("detik 60");
                                            } else {
                                                detik_nonkronis = String.valueOf(Integer.parseInt(cmbDtk.getSelectedItem().toString())+1);
                                            }
                                            if(Integer.parseInt(cmbMnt.getSelectedItem().toString())+1 == 60){
                                                jam_nonkronis = String.valueOf(Integer.parseInt(cmbJam.getSelectedItem().toString())+1);
                                                menit_nonkronis = "00";
                                                //System.out.println("menit 60");
                                            }
                                            if(Integer.parseInt(cmbJam.getSelectedItem().toString())+1 == 24){
                                                jam_nonkronis = "00";
                                                //System.out.println("jam 24");
                                            }
//                                            System.out.println("detik kronis "+detik_kronis);
//                                            System.out.println("detik non kronis "+detik_nonkronis);
                                            //(jumlah_kronis/carikapasitas.getDouble(1))
                                            //(Double.parseDouble(tbObat.getValueAt(i,6).toString())*(jumlah_kronis/carikapasitas.getDouble(1)))
                                            simpan_kronis = Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",17,new String[]{
                                                            Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+detik_kronis,TNoRw.getText(),tbObat.getValueAt(i,2).toString(),tbObat.getValueAt(i,13).toString(),
                                                            tbObat.getValueAt(i,6).toString(),""+jumlah_kronis,
                                                            tbObat.getValueAt(i,8).toString(),tbObat.getValueAt(i,9).toString(),""+Math.round(
                                                                    Double.parseDouble(tbObat.getValueAt(i,8).toString())+
                                                                    Double.parseDouble(tbObat.getValueAt(i,9).toString())+
                                                                    (Double.parseDouble(tbObat.getValueAt(i,6).toString())*jumlah_kronis)),
                                                            "Ralan",kdgudang.getText(),tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString(), "1", ""+jumlah_obat,obat_kemo
                                                        });
                                            
                                            //(jumlah_nonkronis/carikapasitas.getDouble(1))
                                            simpan_nonkronis = Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",17,new String[]{
                                                            Valid.SetTgl(DTPTgl.getSelectedItem()+""),jam_nonkronis+":"+menit_nonkronis+":"+detik_nonkronis,TNoRw.getText(),tbObat.getValueAt(i,2).toString(),tbObat.getValueAt(i,13).toString(),
                                                            tbObat.getValueAt(i,6).toString(),""+jumlah_nonkronis,
                                                            tbObat.getValueAt(i,8).toString(),tbObat.getValueAt(i,9).toString(),""+Math.round(
                                                                Double.parseDouble(tbObat.getValueAt(i,8).toString())+
                                                                Double.parseDouble(tbObat.getValueAt(i,9).toString())+
                                                                (Double.parseDouble(tbObat.getValueAt(i,6).toString())*jumlah_nonkronis)),
                                                            "Ralan",kdgudang.getText(),tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString(), "0", "0",obat_kemo
                                                        });
                                        } else {
                                            //System.out.println("bukan obat kronis");
                                            //(jumlah_obat/carikapasitas.getDouble(1))
                                            simpan_nonkronis = Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",17,new String[]{
                                                            ...
                                                            tbObat.getValueAt(i,6).toString(),""+jumlah_obat,
                                                            ...
                                                            Double.parseDouble(tbObat.getValueAt(i,9).toString())+(Double.parseDouble(tbObat.getValueAt(i,6).toString())*jumlah_obat)),
                                                            "Ralan",kdgudang.getText(),tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString(), "0", ""+jumlah_obat,obat_kemo
                                                        });
                                            simpan_kronis = true;
                                        }
                                        //System.out.println("1. simpan kronis "+simpan_kronis+"; simpan non kronis "+simpan_nonkronis);
                                        if(simpan_kronis==true && simpan_nonkronis==true){
                                            //(jumlah_obat/carikapasitas.getDouble(1))));
                                            ttljual=ttljual+Math.round(Double.parseDouble(tbObat.getValueAt(i,8).toString())+
                                                    Double.parseDouble(tbObat.getValueAt(i,9).toString())+(Double.parseDouble(tbObat.getValueAt(i,6).toString())*jumlah_obat));
                                            ttlhpp=ttlhpp+Math.round(Double.parseDouble(tbObat.getValueAt(i,13).toString())*jumlah_obat);
                                            ...
                                            if(aktifkanbatch.equals("yes")){
                                                Sequel.mengedit("data_batch","no_batch=? and kode_brng=? and no_faktur=?","sisa=sisa-?",4,new String[]{
                                                    ""+(jumlah_obat/carikapasitas.getDouble(1)),tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,2).toString(),tbObat.getValueAt(i,17).toString()
                                                });
                                                Trackobat.catatRiwayat(tbObat.getValueAt(i,2).toString(),0,(jumlah_obat/carikapasitas.getDouble(1)),"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan",tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString(),TNoRw.getText()+" "+TNoRM.getText()+" "+TPasien.getText());
                                                Sequel.menyimpan("gudangbarang","'"+tbObat.getValueAt(i,2).toString()+"','"+kdgudang.getText()+"','-"+(jumlah_obat/carikapasitas.getDouble(1))+"','"+tbObat.getValueAt(i,16).toString()+"','"+tbObat.getValueAt(i,17).toString()+"'", 
                                                    "stok=stok-'"+(jumlah_obat/carikapasitas.getDouble(1))+"'","kode_brng='"+tbObat.getValueAt(i,2).toString()+"' and kd_bangsal='"+kdgudang.getText()+"' and no_batch='"+tbObat.getValueAt(i,16).toString()+"' and no_faktur='"+tbObat.getValueAt(i,17).toString()+"'");
                                            }else{
                                                Trackobat.catatRiwayat(tbObat.getValueAt(i,2).toString(),0,(jumlah_obat/carikapasitas.getDouble(1)),"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan","","",TNoRw.getText()+" "+TNoRM.getText()+" "+TPasien.getText());
                                                Sequel.menyimpan("gudangbarang","'"+tbObat.getValueAt(i,2).toString()+"','"+kdgudang.getText()+"','-"+(jumlah_obat/carikapasitas.getDouble(1))+"','',''", 
                                                    "stok=stok-'"+(jumlah_obat/carikapasitas.getDouble(1))+"'","kode_brng='"+tbObat.getValueAt(i,2).toString()+"' and kd_bangsal='"+kdgudang.getText()+"' and no_batch='' and no_faktur=''"); 
                                            }
                                            
                                            //System.out.println("paket HD "+tbObat.getValueAt(i,2).equals("B000009066"));
                                            //System.out.println("paket HD single use ? "+tbObat.getValueAt(i,2).equals("B000009374"));
                                            //begin save data paket HD
                                            if(tbObat.getValueAt(i,2).equals("B000009066")){ //paket HD
                                                //tambah obat untuk paket HD reguler
                                                paketHD.add(new String[] {"G000009929", "0.05"});//Asam Sitrat/citric acid #11
                                                paketHD.add(new String[] {"B000013275", "0.06"});//Renapro/Pehidrol 3% 800cc #17
                                                paketHD.add(new String[] {"G000009754", "4"});//NaCl 500ml infus #16
                                                //System.out.println("size paket HD setelah tambah " + paketHD.size());
                                                //loop untuk mendapatkan where clause yang digunakan dalam pengecekan stok
                                                String kondisi = "";
                                                for (int i = 0; i<paketHD.size(); i++){
                                                    kondisi += "'"+paketHD.get(i)[0].toString()+"',";
                                                }
                                                kondisi = kondisi.substring(0, kondisi.length() -1);
                                                String sqlstr = "select count(*) from gudangbarang  where kode_brng in ("+kondisi.toString()+") and kd_bangsal = 'DP6'"; // and stok > 0 
//                                                System.out.println(sqlstr);
                                                PreparedStatement pscekstok = koneksi.prepareStatement(sqlstr);
                                                ResultSet resultstok = pscekstok.executeQuery();
                                                if(resultstok.next()){ 
                                                    //System.out.println("result stok "+resultstok.getDouble(1) + " ? "+ (resultstok.getDouble(1) == 5));
                                                    if (resultstok.getDouble(1) == 18){
                                                        //loop untuk save setiap obat ke gudangbarang
                                                        for (int i = 0; i<paketHD.size(); i++){
                                                            String kode_brng = paketHD.get(i)[0];
                                                            double jumlah = Double.parseDouble(paketHD.get(i)[1]);
                                                            String kd_bangsal = "DP6";//paketHD.get(i)[3];

                                                            Sequel.menyimpan("gudangbarang","'"+kode_brng+"','"+kd_bangsal+"','-"+(jumlah_obat*jumlah)+"','',''", 
                                                             "stok=stok-'"+(jumlah_obat*jumlah)+"'","kode_brng='"+kode_brng+"' and kd_bangsal='"+kd_bangsal+"' and no_batch='' and no_faktur=''"); 
                                                        }
                                                    } else {
                                                        System.out.println("1. Stok paket HD ada yang tidak lengkap, cek stok terlebih dahulu.");
                                                        JOptionPane.showMessageDialog(null,"Stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                                        sukses=false;
                                                    }
                                                } else {
                                                    System.out.println("1. Seluruh stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                                    JOptionPane.showMessageDialog(null,"Seluruh stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                                    sukses=false;
                                                }
                                            } else if(tbObat.getValueAt(i,2).equals("B000009374")){ //paket HD single use
                                                paketHD.add(new String[] {"G000009754", "2"});//NaCl 500ml infus
                                                ...
                                                ResultSet resultstok = pscekstok.executeQuery();
                                                if(resultstok.next()){ 
                                                    //System.out.println("result stok2 "+resultstok.getDouble(1));
                                                    if (resultstok.getDouble(1) == 16){
                                                        //loop untuk save setiap obat ke gudangbarang
                                                        for (int i = 0; i<paketHD.size(); i++){
                                                            String kode_brng = paketHD.get(i)[0];
                                                            double jumlah = Double.parseDouble(paketHD.get(i)[1]);
                                                        ...
                                                        System.out.println("2. Stok paket HD ada yang tidak lengkap, cek stok terlebih dahulu.");
                                                        JOptionPane.showMessageDialog(null,"Stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                                        sukses=false;
                                                    }
                                                } else {
                                                    System.out.println("2. Seluruh stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                                    JOptionPane.showMessageDialog(null,"Seluruh stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                                    sukses=false;
                                                }
                                            }
                                            //end of save data paket HD
                                            ...
                                            if(aktifpcare.equals("yes")){
                                                ...
                                                simpanObatPCare(
                                                    ...
                                                    signa1,signa2,""+(jumlah_obat/carikapasitas.getDouble(1)),"0","",TNoRw.getText(),
                                    ...
                                    }else{ //jika tidak ada kapasitas
                                        boolean simpan_kronis = false;
                                        boolean simpan_nonkronis = false;
                                        
                                        if(tbObat.getValueAt(i,7).toString().equalsIgnoreCase("kronis")){
                                            //jumlah obat kronis dipecah
//                                             System.out.println("kronis ");
                                            int jumlah_nonkronis = (int) Math.ceil(7 * jumlah_obat/30);
                                            int jumlah_kronis = (int) Math.ceil(jumlah_obat - jumlah_nonkronis);
//                                            double jumlah_nonkronis = 7 * jumlah_obat/30;
//                                            double jumlah_kronis = jumlah_obat - jumlah_nonkronis;
...
//                                            System.out.println("detik non kronis "+detik_nonkronis);
                                        ...
                                        //System.out.println("2. simpan kronis "+simpan_kronis+"; simpan non kronis "+simpan_nonkronis);
                                        if(simpan_kronis==true && simpan_nonkronis==true){
                                            ttljual=ttljual+Math.round(Double.parseDouble(tbObat.getValueAt(i,8).toString())+
                                                    Double.parseDouble(tbObat.getValueAt(i,9).toString())+(Double.parseDouble(tbObat.getValueAt(i,6).toString())*jumlah_obat));
                                            ttlhpp=ttlhpp+Math.round(Double.parseDouble(tbObat.getValueAt(i,13).toString())*jumlah_obat);
                                            ...
                                            if(aktifkanbatch.equals("yes")){
                                                Sequel.mengedit("data_batch","no_batch=? and kode_brng=? and no_faktur=?","sisa=sisa-?",4,new String[]{
                                                    ""+(jumlah_obat),tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,2).toString(),tbObat.getValueAt(i,17).toString()
                                                });
                                                Trackobat.catatRiwayat(tbObat.getValueAt(i,2).toString(),0,jumlah_obat,"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan",tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString(),TNoRw.getText()+" "+TNoRM.getText()+" "+TPasien.getText());
                                                Sequel.menyimpan("gudangbarang","'"+tbObat.getValueAt(i,2).toString()+"','"+kdgudang.getText()+"','-"+jumlah_obat+"','"+tbObat.getValueAt(i,16).toString()+"','"+tbObat.getValueAt(i,17).toString()+"'", 
                                                         "stok=stok-'"+jumlah_obat+"'","kode_brng='"+tbObat.getValueAt(i,2).toString()+"' and kd_bangsal='"+kdgudang.getText()+"' and no_batch='"+tbObat.getValueAt(i,16).toString()+"' and no_faktur='"+tbObat.getValueAt(i,17).toString()+"'");   
                                            }else{ 
                                                Trackobat.catatRiwayat(tbObat.getValueAt(i,2).toString(),0,jumlah_obat,"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan","","",TNoRw.getText()+" "+TNoRM.getText()+" "+TPasien.getText());
                                                Sequel.menyimpan("gudangbarang","'"+tbObat.getValueAt(i,2).toString()+"','"+kdgudang.getText()+"','-"+jumlah_obat+"','',''", 
                                                         "stok=stok-'"+jumlah_obat+"'","kode_brng='"+tbObat.getValueAt(i,2).toString()+"' and kd_bangsal='"+kdgudang.getText()+"' and no_batch='' and no_faktur=''");  
                                            }
                                            ...
                                            if(tbObat.getValueAt(i,2).equals("B000009066")){ //paket HD
                                                ...
                                                if(resultstok.next()){ 
                                                    ...
                                                    if (resultstok.getDouble(1) == 18){
                                                        ...
                                                        System.out.println("3. Stok paket HD ada yang tidak lengkap, cek stok terlebih dahulu.");
                                                        JOptionPane.showMessageDialog(null,"Stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                                        sukses=false;
                                                    }
                                                } else {
                                                    System.out.println("3. Seluruh stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                                    JOptionPane.showMessageDialog(null,"Seluruh stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                                    sukses=false;
                                                }
                                            } else if(tbObat.getValueAt(i,2).equals("B000009374")){ //paket HD single use
                                                ...
                                                if(resultstok.next()){ 
                                                    ...
                                                    if (resultstok.getDouble(1) == 16){
                                                        ...
                                                        System.out.println("4. Stok paket HD ada yang tidak lengkap, cek stok terlebih dahulu.");
                                                        JOptionPane.showMessageDialog(null,"Stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                                        sukses=false;
                                                    }
                                                } else {
                                                    System.out.println("4. Seluruh stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                                    JOptionPane.showMessageDialog(null,"Seluruh stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                                    sukses=false;
                                                }
                                            }
                                            ...
                                            if(aktifpcare.equals("yes")){
                                                ...
                                                simpanObatPCare(
                                                    nokunjungan,"false",Sequel.cariIsi("select kode_brng_pcare from maping_obat_pcare where kode_brng=?",tbObat.getValueAt(i,2).toString()),
                                                    signa1,signa2,""+jumlah_obat,"0","",TNoRw.getText(),
                                                    Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),
                                                    tbObat.getValueAt(i,2).toString(),tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString()
                                                );
                                            }
                                ...
                                obat_kemo = (tbObat.getValueAt(i,19).toString().equals("true")) ? "1":"0";
                                double jumlah_obat = Double.parseDouble(tbObat.getValueAt(i,1).toString());
                                if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",17,new String[]{
                                    Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),TNoRw.getText(),tbObat.getValueAt(i,2).toString(),tbObat.getValueAt(i,13).toString(),
                                    ...
                                    "Ralan",kdgudang.getText(),tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString(), "0", ""+Double.parseDouble(tbObat.getValueAt(i,1).toString()),obat_kemo
                                })==true){
                                    ttljual=ttljual+Math.round(Double.parseDouble(tbObat.getValueAt(i,8).toString())+
                                            Double.parseDouble(tbObat.getValueAt(i,9).toString())+(Double.parseDouble(tbObat.getValueAt(i,6).toString())*
                                                    Double.parseDouble(tbObat.getValueAt(i,1).toString())));
                                    ...
                                    if(tbObat.getValueAt(i,2).equals("B000009066")){ //paket HD
                                        ...
                                        if(resultstok.next()){ 
                                            ...
                                            if (resultstok.getDouble(1) == 18){
                                                ...
                                                System.out.println("5. Stok paket HD ada yang tidak lengkap, cek stok terlebih dahulu.");
                                                JOptionPane.showMessageDialog(null,"Stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                                sukses=false;
                                            }
                                        } else {
                                            System.out.println("5. Seluruh stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                            JOptionPane.showMessageDialog(null,"Seluruh stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                            sukses=false;
                                        }
                                    } else if(tbObat.getValueAt(i,2).equals("B000009374")){ //paket HD single use
                                        ...
                                        if(resultstok.next()){ 
                                            ...
                                            if (resultstok.getDouble(1) == 16){
                                                ...
                                                System.out.println("6. Stok paket HD ada yang tidak lengkap, cek stok terlebih dahulu.");
                                                JOptionPane.showMessageDialog(null,"Stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                                sukses=false;
                                            }
                                        } else {
                                            System.out.println("6. Seluruh stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                            JOptionPane.showMessageDialog(null,"Seluruh stok paket HD tidak lengkap, cek stok terlebih dahulu.");
                                            sukses=false;
                                        }
                                    }
                    ...
                    for(i=0;i<tbDetailObatRacikan.getRowCount();i++){ 
                        if(Valid.SetAngka(tbDetailObatRacikan.getValueAt(i,10).toString())>0){
                            float jml_obat_racikan = Math.round(Double.parseDouble(tbDetailObatRacikan.getValueAt(i,10).toString()));
                            if(Sequel.menyimpantf2("detail_obat_racikan","?,?,?,?,?","Data",5,new String[]{
                               ...
                               tbDetailObatRacikan.getValueAt(i,0).toString(),tbDetailObatRacikan.getValueAt(i,1).toString()
                                ...
                                if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",17,new String[]{
                                    ...
                                    tbDetailObatRacikan.getValueAt(i,4).toString(),""+jml_obat_racikan,
                                    ...
                                    ""+Math.round(Double.parseDouble(tbDetailObatRacikan.getValueAt(i,11).toString())+                                        
                                        ...
                                        jml_obat_racikan)),
                                    "Ralan",kdgudang.getText(),tbDetailObatRacikan.getValueAt(i,16).toString(),tbDetailObatRacikan.getValueAt(i,17).toString(), "0", ""+jml_obat_racikan,"0"
                                })==true){
                                    ...
                                    if(aktifkanbatch.equals("yes")){
                                        Sequel.mengedit("data_batch","no_batch=? and kode_brng=? and no_faktur=?","sisa=sisa-?",4,new String[]{
                                            ""+jml_obat_racikan,tbDetailObatRacikan.getValueAt(i,16).toString(),tbDetailObatRacikan.getValueAt(i,1).toString(),tbDetailObatRacikan.getValueAt(i,17).toString()
                                        }); 
                                        Trackobat.catatRiwayat(tbDetailObatRacikan.getValueAt(i,1).toString(),0,jml_obat_racikan,"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan",tbDetailObatRacikan.getValueAt(i,16).toString(),tbDetailObatRacikan.getValueAt(i,17).toString(),TNoRw.getText()+" "+TNoRM.getText()+" "+TPasien.getText());
                                        Sequel.menyimpan("gudangbarang","'"+tbDetailObatRacikan.getValueAt(i,1).toString()+"','"+kdgudang.getText()+"','-"+jml_obat_racikan+"','"+tbDetailObatRacikan.getValueAt(i,16).toString()+"','"+tbDetailObatRacikan.getValueAt(i,17).toString()+"'", 
                                                 "stok=stok-'"+jml_obat_racikan+"'","kode_brng='"+tbDetailObatRacikan.getValueAt(i,1).toString()+"' and kd_bangsal='"+kdgudang.getText()+"' and no_batch='"+tbDetailObatRacikan.getValueAt(i,16).toString()+"' and no_faktur='"+tbDetailObatRacikan.getValueAt(i,17).toString()+"'");  
                                    }else{
                                        Trackobat.catatRiwayat(tbDetailObatRacikan.getValueAt(i,1).toString(),0,jml_obat_racikan,"Pemberian Obat",akses.getkode(),kdgudang.getText(),"Simpan","","",TNoRw.getText()+" "+TNoRM.getText()+" "+TPasien.getText());
                                        Sequel.menyimpan("gudangbarang","'"+tbDetailObatRacikan.getValueAt(i,1).toString()+"','"+kdgudang.getText()+"','-"+jml_obat_racikan+"','',''", 
                                                 "stok=stok-'"+jml_obat_racikan+"'","kode_brng='"+tbDetailObatRacikan.getValueAt(i,1).toString()+"' and kd_bangsal='"+kdgudang.getText()+"' and no_batch='' and no_faktur=''");   
                                    }
                                    if(aktifpcare.equals("yes")){
                                        ...
                                        simpanObatPCare(
                                            ...
                                            signa1,signa2,""+jml_obat_racikan,"0","",TNoRw.getText(),
                                            Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),
    ...
    public void tampilobat() {        
        ...
        for(i=0;i<tbObat.getRowCount();i++){
            if(!tbObat.getValueAt(i,1).toString().equals("")){
                ...
                pilihKemo[z]=Boolean.parseBoolean(tbObat.getValueAt(i,19).toString());
                z++;
            }
        }
        ...
        for(i=0;i<z;i++){
            tabModeobat.addRow(new Object[] {
                ...
                eb[i],ts[i],stok[i],aturan[i],industri[i],beli[i],kategori[i],golongan[i],nobatch[i],nofaktur[i],kadaluarsa[i], pilihKemo[i]
            });
        }
        String qrystokkosong="";
                ...
                if(aktifkanbatch.equals("yes")){
                    if(aktifpcare.equals("yes")){
                        sql="select data_batch.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(data_batch.h_beli+(data_batch.h_beli*?)) as harga,"+
                            ...
                            " data_batch.no_batch,data_batch.no_faktur,data_batch.tgl_kadaluarsa,FLOOR(gudangbarang.stok) AS stok,data_batch."+hppfarmasi+" as dasar "+
                    ...
                    psobat=koneksi.prepareStatement(
                        sql+" where gudangbarang.kd_bangsal=?  "+qrystokkosong+" "+(TCari.getText().trim().equals("")?"":
...
//                        "order by data_batch.tgl_kadaluarsa asc");
                    try{
                        ...
                        while(rsobat.next()){
                            tabModeobat.addRow(new Object[] {false,"",rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                               ...
                               rsobat.getString("no_batch"),rsobat.getString("no_faktur"),rsobat.getString("tgl_kadaluarsa"),false
                            });          
                        }
                    }catch(Exception e){
                    ...
                    if(aktifpcare.equals("yes")){
                        sql="select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                            " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,kategori_barang.nama as kategori,FLOOR(gudangbarang.stok) AS stok,golongan_barang.nama as golongan,databarang."+hppfarmasi+" as dasar "+
                    ...
                    psobat=koneksi.prepareStatement(
                        sql+" where gudangbarang.no_batch='' and gudangbarang.no_faktur='' "+qrystokkosong+"  and gudangbarang.kd_bangsal=? and databarang.status='1' "+
...
//                        "jenis.nama like ? or databarang.letak_barang like ?)")+" order by data_batch.tgl_kadaluarsa asc");
                    ...
                    if(aktifpcare.equals("yes")){
                        sql="select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,databarang.karyawan,databarang.ralan,databarang.beliluar,FLOOR(gudangbarang.stok) AS stok,"+
                    ...
                    try{
                        ...
                        while(rsobat.next()){
                            ...
                            psbatch=koneksi.prepareStatement(
                                ...
                                "data_batch.h_beli,(data_batch.h_beli+(data_batch.h_beli*?)) as harga, FLOOR(gudangbarang.stok) AS stok,data_batch."+hppfarmasi+" as dasar from data_batch inner join gudangbarang "+
                                ...
                                " data_batch.kode_brng=? and gudangbarang.kd_bangsal=? order by data_batch.tgl_kadaluarsa desc limit 1");
//                            psbatch=koneksi.prepareStatement(
//                                "select data_batch.no_batch, data_batch.kode_brng, data_batch.tgl_beli, data_batch.tgl_kadaluarsa, data_batch.asal, data_batch.no_faktur, "+
...
//                                "gudangbarang.stok>0 and data_batch.kode_brng=? and gudangbarang.kd_bangsal=? order by data_batch.tgl_kadaluarsa desc limit 1");
                            ...
                            if(rsobat.getDouble("jml")>sisacari){
                                JOptionPane.showMessageDialog(rootPane,"Maaf stok "+rsobat.getString("nama_brng").toString()+" tidak mencukupi..!!");
                                tabModeobat.addRow(new Object[] {
                                   ...
                                   h_belicari,rsobat.getString("kategori"),rsobat.getString("golongan"),no_batchcari,no_fakturcari,tgl_kadaluarsacari,false
                                });   
                            }else{
                                tabModeobat.addRow(new Object[] {
                    ...
                    try{
                        ...
                        while(rsobat.next()){
                            ...
                            psbatch=koneksi.prepareStatement(
                                ...
                                "data_batch.jualbebas, data_batch.karyawan, data_batch.jumlahbeli,FLOOR(gudangbarang.stok) AS stok,data_batch."+hppfarmasi+" as dasar from data_batch inner join gudangbarang "+
                                "on data_batch.kode_brng=gudangbarang.kode_brng and data_batch.no_batch=gudangbarang.no_batch and data_batch.no_faktur=gudangbarang.no_faktur where "+
                                " data_batch.kode_brng=? and gudangbarang.kd_bangsal=? order by data_batch.tgl_kadaluarsa desc limit 1");
//                            psbatch=koneksi.prepareStatement(
//                                "select data_batch.no_batch, data_batch.kode_brng, data_batch.tgl_beli, data_batch.tgl_kadaluarsa, data_batch.asal, data_batch.no_faktur, "+
...
//                                        "gudangbarang.stok>0 and data_batch.kode_brng=? and gudangbarang.kd_bangsal=? order by data_batch.tgl_kadaluarsa desc limit 1");
                                    ...
                                    if(rs2.getDouble("jml")>sisacari){
                                        JOptionPane.showMessageDialog(rootPane,"Maaf stok "+rs2.getString("nama_brng").toString()+" tidak mencukupi..!!");
...
//                                    pscarikapasitas= koneksi.prepareStatement("select IFNULL(databarang.kapasitas,1) from databarang where databarang.kode_brng=?");                                      
                            ...
                            //bypass stok boleh minus
//                            if(stokbarang<y){
//                                JOptionPane.showMessageDialog(rootPane,"Maaf stok tidak mencukupi..!!");
//                                System.out.println("maaf stok 9");
...
//                    pscarikapasitas= koneksi.prepareStatement("select IFNULL(databarang.kapasitas,1) from databarang where databarang.kode_brng=?");                                      
            ...
            if(stokbarang<y){
                JOptionPane.showMessageDialog(rootPane,"Maaf stok "+data+" tidak mencukupi..!!");
            }
        } catch (Exception e) {
        ...
        try {
            if(kenaikan>0){
                if(aktifkanbatch.equals("yes")){
                    ...
                    psobat=koneksi.prepareStatement(
                        sql+" where gudangbarang.kd_bangsal=? "+(TCari.getText().trim().equals("")?"":
                        "and (databarang.kode_brng like ? or databarang.nama_brng like ? or kategori_barang.nama like ? or "+
                        "golongan_barang.nama like ? or data_batch.no_batch like ? or data_batch.no_faktur like ? or "+
                        "jenis.nama like ? or databarang.letak_barang like ?) ")+
                        "order by data_batch.tgl_kadaluarsa asc");
...
//                        "order by data_batch.tgl_kadaluarsa asc");
                    ...
                    if(aktifpcare.equals("yes")){
                        sql="select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,databarang."+hppfarmasi+" as dasar,FLOOR(gudangbarang.stok) AS stok,"+
                            " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,kategori_barang.nama as kategori,golongan_barang.nama as golongan,databarang.kapasitas "+
                            " from databarang inner join jenis on databarang.kdjns=jenis.kdjns "+
                            " inner join industrifarmasi on industrifarmasi.kode_industri=databarang.kode_industri "+
                            " inner join golongan_barang on databarang.kode_golongan=golongan_barang.kode "+
                    ...
                    psobat=koneksi.prepareStatement(
                        sql+" where gudangbarang.no_batch='' and gudangbarang.no_faktur='' and gudangbarang.kd_bangsal=? and databarang.status='1' "+
                        (TCari.getText().trim().equals("")?"":" and (databarang.kode_brng like ? or databarang.nama_brng like ? or kategori_barang.nama like ? or "+
                        "golongan_barang.nama like ? or jenis.nama like ? or databarang.letak_barang like ?) ")+
                        "order by databarang.nama_brng");
//                    psobat=koneksi.prepareStatement(
...
//                        "jenis.nama like ? or databarang.letak_barang like ?)")+" order by data_batch.tgl_kadaluarsa asc");
                    ...
                    if(aktifpcare.equals("yes")){
                        sql="select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,databarang.karyawan,databarang.ralan,databarang.beliluar,databarang."+hppfarmasi+" as dasar,FLOOR(gudangbarang.stok) AS stok,"+
