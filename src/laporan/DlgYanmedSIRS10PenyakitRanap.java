...
public class DlgYanmedSIRS10PenyakitRanap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgYanmedSIRS10PenyakitRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan SIRS RL 5.3 10 Penyakit Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgYanmedSIRS10PenyakitRanap dialog = new DlgYanmedSIRS10PenyakitRanap(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >PASIEN KELUAR HIDUP LAKI-LAKI</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >PASIEN KELUAR HIDUP PEREMPUAN</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >PASIEN KELUAR MENINGGAL LAKI-LAKI</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >PASIEN KELUAR MENINGGAL PEREMPUAN</td>"+
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "SUM(CASE WHEN pa.jk = 'L' AND ki.stts_pulang <> 'Meninggal' THEN 1 ELSE 0 END) l_tm, \n" +
                    "SUM(CASE WHEN pa.jk = 'P' AND ki.stts_pulang <> 'Meninggal'  THEN 1 ELSE 0 END) p_tm,\n" +
                    "SUM(CASE WHEN pa.jk = 'L' AND ki.stts_pulang = 'Meninggal' THEN 1 ELSE 0 END) l_m, \n" +
                    "SUM(CASE WHEN pa.jk = 'P' AND ki.stts_pulang = 'Meninggal'  THEN 1 ELSE 0 END) p_m\n" +
                    "FROM reg_periksa r\n" +
                ...
                while(rs.next()){
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' align='center'>"+rs.getString("l_tm")+"</td>"+
                            "<td valign='middle' align='center'>"+rs.getString("p_tm")+"</td>"+
                            "<td valign='middle' align='center'>"+rs.getString("l_m")+"</td>"+
                            "<td valign='middle' align='center'>"+rs.getString("p_m")+"</td>"+
