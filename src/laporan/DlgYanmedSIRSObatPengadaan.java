...
public class DlgYanmedSIRSObatPengadaan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgYanmedSIRSObatPengadaan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan SIRS RL 3.13a Obat Pengadaan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgYanmedSIRSObatPengadaan dialog = new DlgYanmedSIRSObatPengadaan(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='3%' >JUMLAH ITEM OBAT</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='3%' >JUMLAH STOK OBAT</td>"+
            ...
            ps=koneksi.prepareStatement(
                    "SELECT k.nama, COUNT(d.kode_brng) AS jml, ROUND(SUM(g.stok),0) AS stok \n" +
                    "FROM databarang d \n" +
                    "INNER JOIN kategori_barang k ON k.kode = d.kode_kategori\n" +
                    "INNER JOIN gudangbarang g ON g.kode_brng = d.kode_brng\n" +
                    "WHERE k.nama <> '-'\n" +
                    "GROUP BY k.nama");
            try {
                i=1;                     
                ...
                while(rs.next()){
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' align='center'>"+rs.getString("stok")+"</td>"+
