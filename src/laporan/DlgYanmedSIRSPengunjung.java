...
public class DlgYanmedSIRSPengunjung extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgYanmedSIRSPengunjung(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan SIRS RL 5.1 Pengunjung ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgYanmedSIRSPengunjung dialog = new DlgYanmedSIRSPengunjung(new javax.swing.JFrame(), true);
    ...
    private void prosesCari() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    "SELECT COUNT(r.no_rawat) as jml, \n" +
                    "SUM(CASE WHEN pa.jk = 'L' THEN 1 ELSE 0 END) l, \n" +
                    "SUM(CASE WHEN pa.jk = 'P' THEN 1 ELSE 0 END) p, r.stts_daftar\n" +
                    "FROM reg_periksa r\n" +
                    "INNER JOIN pasien pa ON pa.no_rkm_medis = r.no_rkm_medis\n" +
                    "WHERE r.tgl_registrasi BETWEEN ? AND ?\n" +
                    "GROUP BY r.stts_daftar \n" +
                    "ORDER BY stts_daftar DESC");
            try {
                i=1;                     
                ...
                while(rs.next()){
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' align='center'>Pengunjung "+rs.getString("stts_daftar")+"</td>"+
