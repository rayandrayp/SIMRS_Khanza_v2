 ...
 * @author perpustakaan
 */
public final class DlgDataHAIsIDO extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgDataHAIsIDO(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "ETT","CVL","IVL","UC","VAP","IAD","Pleb","ISK","IDO","HAP","Tinea",
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data HAIs IDO ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-07-2022" }));
        ...
        jLabel14.setBounds(450, 100, 40, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("data_HAIs","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",21,new String[]{
                    ...
                    Sputum.getText(),Darah.getText(),Urine.getText(),Antibiotik.getText(),Kamar.getText(),tirah_baring.getSelectedItem().toString()
                })==true){
                    tampil();
                    emptTeks();
            }   
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDataHAIsIDO dialog = new DlgDataHAIsIDO(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "concat(data_HAIs.kd_kamar,', ',bangsal.nm_bangsal),data_HAIs.kd_kamar, diagnosa_pasien.kd_penyakit from data_HAIs inner join reg_periksa "+
                    "inner join pasien inner join kamar inner join bangsal  INNER JOIN diagnosa_pasien INNER JOIN penyakit on data_HAIs.kd_kamar=kamar.kd_kamar "+
                    "and kamar.kd_bangsal=bangsal.kd_bangsal and data_HAIs.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+ 
                    " AND data_HAIs.no_rawat=diagnosa_pasien.no_rawat AND diagnosa_pasien.kd_penyakit=penyakit.kd_penyakit where "+
