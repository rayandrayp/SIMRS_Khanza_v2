...
public class DlgYanmedSIRSRujukan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgYanmedSIRSRujukan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan SIRS RL 3.14 Rujukan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgYanmedSIRSRujukan dialog = new DlgYanmedSIRSRujukan(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='13%' >JENIS SPESIALISASI</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='3%' >RUJUKAN DARI PUSKESMAS</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='3%' >RUJUKAN DARI FASKES LAIN</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='3%' >RUJUKAN DARI RS LAIN</td>"+
            ...
            ps=koneksi.prepareStatement(
                    "SELECT p.nm_poli, \n" +
                    "SUM(CASE WHEN rm.perujuk LIKE 'PUSKESMAS%' THEN 1 ELSE 0 END) puskesmas, \n" +
                    "SUM(CASE WHEN rm.perujuk NOT LIKE 'PUSKESMAS%' OR rm.perujuk NOT LIKE 'RS%' OR rm.perujuk NOT LIKE 'RU%' THEN 1 ELSE 0 END) faskes, \n" +
                    "SUM(CASE WHEN rm.perujuk LIKE 'RS%' OR rm.perujuk LIKE 'RU%' THEN 1 ELSE 0 END) rs\n" +
                    "FROM rujuk_masuk rm\n" +
                    "INNER JOIN reg_periksa rp ON rp.no_rawat = rm.no_rawat\n" +
                ...
                while(rs.next()){
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' align='center'>"+rs.getString("puskesmas")+"</td>"+
                            "<td valign='middle' align='center'>"+rs.getString("faskes")+"</td>"+
                            "<td valign='middle' align='center'>"+rs.getString("rs")+"</td>"+
