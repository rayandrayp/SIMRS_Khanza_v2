...
public class DlgYanmedKebidananPerinatologi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgYanmedKebidananPerinatologi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan Kebidanan dan Perinatologi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgYanmedKebidananPerinatologi dialog = new DlgYanmedKebidananPerinatologi(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='9%' rowspan='2'>Pengunjung</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='20%' colspan='3'>Kehamilan</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='20%' colspan='3'>Akhir Kehamilan</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='20%' colspan='3'>Persalinan Dengan Komplikasi</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='15%' colspan='2'>Berat Badan Bayi Baru Lahir</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='15%' colspan='2'>Yang Menolong Persalinan</td>"+
                "</tr>"+
                "<tr class='isi'>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center'>Paritas Ke</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center'>Masa Gestasi</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center'>Paritas Sebelumnya</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center'>Abortus</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center'>Lahir Hidup</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center'>Lahir Mati</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center'>Normal</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center'>Tind. Non-Bedah</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center'>Sectio Caesari</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center'><2.5 KG</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center'>>2.5 KG</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center'>Dokter</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center'>Bidan</td>"+
                "</tr>" +
                "<tr class='isi'>"+
            ...
            ps=koneksi.prepareStatement(
                    "select data_HAIs.tanggal from data_HAIs inner join reg_periksa inner join kamar inner join bangsal inner join penjab on data_HAIs.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and data_HAIs.no_rawat=reg_periksa.no_rawat and reg_periksa.kd_pj=penjab.kd_pj where tanggal between ? and ?  group by tanggal order by tanggal");
            try {
                i=1;
                ...
                rs=ps.executeQuery();
                while(rs.next()){
                    pasien=Sequel.cariInteger("select count(data_HAIs.no_rawat) from data_HAIs inner join reg_periksa inner join kamar inner join bangsal inner join penjab on data_HAIs.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and data_HAIs.no_rawat=reg_periksa.no_rawat and reg_periksa.kd_pj=penjab.kd_pj where data_HAIs.tanggal=? ",rs.getString("tanggal"));
                    ...
                    deku=Sequel.cariInteger("select count(data_HAIs.no_rawat) from data_HAIs inner join reg_periksa inner join kamar inner join bangsal inner join penjab on data_HAIs.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and data_HAIs.no_rawat=reg_periksa.no_rawat and reg_periksa.kd_pj=penjab.kd_pj where data_HAIs.DEKU='IYA' and tanggal=? ",rs.getString("tanggal"));
                    jmldeku=jmldeku+deku;
                    sputum=Sequel.cariInteger("select count(data_HAIs.no_rawat) from data_HAIs inner join reg_periksa inner join kamar inner join bangsal inner join penjab on data_HAIs.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and data_HAIs.no_rawat=reg_periksa.no_rawat and reg_periksa.kd_pj=penjab.kd_pj where data_HAIs.SPUTUM<>'' and tanggal=? ",rs.getString("tanggal"));
                    jmlsputum=jmlsputum+sputum;
                    darah=Sequel.cariInteger("select count(data_HAIs.no_rawat) from data_HAIs inner join reg_periksa inner join kamar inner join bangsal inner join penjab on data_HAIs.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and data_HAIs.no_rawat=reg_periksa.no_rawat and reg_periksa.kd_pj=penjab.kd_pj where data_HAIs.DARAH<>'' and tanggal=? ",rs.getString("tanggal"));
                    jmldarah=jmldarah+darah;
                    urine=Sequel.cariInteger("select count(data_HAIs.no_rawat) from data_HAIs inner join reg_periksa inner join kamar inner join bangsal inner join penjab on data_HAIs.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and data_HAIs.no_rawat=reg_periksa.no_rawat and reg_periksa.kd_pj=penjab.kd_pj where data_HAIs.URINE<>'' and tanggal=? ",rs.getString("tanggal"));
                    jmlurine=jmlurine+urine;
                    ANTIBIOTIK=Sequel.cariInteger("select count(data_HAIs.no_rawat) from data_HAIs inner join reg_periksa inner join kamar inner join bangsal inner join penjab on data_HAIs.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and data_HAIs.no_rawat=reg_periksa.no_rawat and reg_periksa.kd_pj=penjab.kd_pj where data_HAIs.ANTIBIOTIK<>'' and tanggal=? ",rs.getString("tanggal"));
