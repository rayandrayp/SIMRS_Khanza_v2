...
public class DlgYanmedSIRSKetenagaan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgYanmedSIRSKetenagaan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan SIRS Ketenagaan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgYanmedSIRSKetenagaan dialog = new DlgYanmedSIRSKetenagaan(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='3%' >KUALIFIKASI PENDIDIKAN</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >KEADAAN LAKI-LAKI</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >KEADAAN PEREMPUAN</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >KEBUTUHAN LAKI-LAKI</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >KEBUTUHAN PEREMPUAN</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >KEKURANGAN LAKI-LAKI</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >KEKURANGAN PEREMPUAN</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >JUMLAH KEADAAN</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >JUMLAH KEBUTUHAN</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >JUMLAH KEKURANGAN</td>"+
            ...
            ps=koneksi.prepareStatement(
                    "SELECT s.nm_sps, COUNT(s.nm_sps) AS jml, \n" +
                    "SUM(CASE WHEN d.jk = 'L' THEN 1 ELSE 0 END) l, \n" +
                    "SUM(CASE WHEN d.jk = 'P' THEN 1 ELSE 0 END) p \n" +
                    "FROM dokter d\n" +
                ...
                while(rs.next()){
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' align='center'>"+rs.getString("nm_sps")+"</td>"+
