...
public class DlgYanmedSIRSPelayananKhusus extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgYanmedSIRSPelayananKhusus(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan SIRS RL 3.10 Pelayanan Khusus ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgYanmedSIRSPelayananKhusus dialog = new DlgYanmedSIRSPelayananKhusus(new javax.swing.JFrame(), true);
    ...
    private void prosesCari() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    "SELECT jp.nm_perawatan, COUNT(rj.no_rawat) AS jml\n" +
                    "FROM rawat_jl_drpr rj\n" +
                    "INNER JOIN reg_periksa r ON r.no_rawat = rj.no_rawat\n" +
                    "INNER JOIN jns_perawatan jp ON jp.kd_jenis_prw = rj.kd_jenis_prw\n" +
                    "WHERE r.tgl_registrasi BETWEEN ? AND ? \n" +
                    "AND rj.kd_jenis_prw IN (SELECT kd_jenis_prw FROM jns_perawatan WHERE nm_perawatan LIKE '%EKG%' OR \n" +
                    "nm_perawatan LIKE '%EMG%' OR \n" +
                    "nm_perawatan LIKE '%ECG%' OR\n" +
                    "nm_perawatan LIKE '%endoskopi%' OR  \n" +
                    "nm_perawatan LIKE '%haemodialisa%' OR  \n" +
                    "nm_perawatan LIKE '%densometri%' OR \n" +
                    "nm_perawatan LIKE '%pungsi%' OR \n" +
                    "nm_perawatan LIKE '%alergi%' OR\n" +
                    "nm_perawatan LIKE '%topometri%' OR \n" +
                    "nm_perawatan LIKE '%akupunktur%' OR \n" +
                    "nm_perawatan LIKE '%hiperbarik%')\n" +
                    "GROUP BY jp.nm_perawatan\n" +
