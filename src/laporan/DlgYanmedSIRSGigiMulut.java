...
public class DlgYanmedSIRSGigiMulut extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgYanmedSIRSGigiMulut(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan SIRS RL 3.3 Gigi Mulut ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgYanmedSIRSGigiMulut dialog = new DlgYanmedSIRSGigiMulut(new javax.swing.JFrame(), true);
    ...
    private void prosesCari() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    "SELECT j.nm_perawatan, COUNT(r.no_rawat) AS jml\n" +
                    "FROM jns_perawatan j\n" +
                    "LEFT JOIN rawat_jl_drpr r ON r.kd_jenis_prw = j.kd_jenis_prw\n" +
                    "WHERE j.nm_perawatan LIKE '%gigi%' AND r.tgl_perawatan BETWEEN ? AND ?\n" +
                    "GROUP BY j.nm_perawatan");
            try {
                i=1;                    
