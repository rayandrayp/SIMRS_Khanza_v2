...
public class DlgYanmed10BesarPenyakit extends javax.swing.JDialog {
    ...
    private String queryRalan, queryRanap;
    
    /** Creates new form DlgProgramStudi
     * @param parent
     * @param modal */
    public DlgYanmed10BesarPenyakit(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgYanmed10BesarPenyakit dialog = new DlgYanmed10BesarPenyakit(new javax.swing.JFrame(), true);
    ...
    private void prosesCari() {
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        try {
            queryRanap = "SELECT pe.nm_penyakit, COUNT(d.kd_penyakit) as COUNT,\n" +
                        ...
                        "WHERE pe.nm_penyakit <> '-'  AND k.tgl_masuk BETWEEN ? AND ?\n" +
                        "GROUP BY d.kd_penyakit ORDER BY `count` DESC Limit 10";
            
            queryRalan = "SELECT pe.nm_penyakit, COUNT(d.kd_penyakit) as COUNT,\n" +
                        ...
                        "    SUM(CASE WHEN r.status_lanjut = 'Ralan' AND r.kd_pj IN ('A65', 'BPJ') THEN 1 ELSE 0 END) bpjs,\n" +
                        "    SUM(CASE WHEN r.status_lanjut = 'Ralan' AND r.kd_pj NOT IN ('A65', 'BPJ') THEN 1 ELSE 0 END) umum\n" +
                        "FROM reg_periksa r\n" +
                        ...
                        "LEFT JOIN pasien_tni pt ON pt.no_rkm_medis = p.no_rkm_medis\n" +
                        "LEFT JOIN golongan_tni gt ON gt.id = pt.golongan_tni " +
                        "WHERE pe.nm_penyakit <> '-' AND r.tgl_registrasi BETWEEN ? AND ?\n" +
                        "GROUP BY d.kd_penyakit ORDER BY `count` DESC Limit 10";
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='29%' rowspan='2'>Nama Penyakit</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='20%' colspan='3'>TNI AD</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='20%' colspan='3'>Angkatan Lain</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='5%' rowspan='2'>Siswa Dikma</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='5%' rowspan='2'>Taruna</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='5%' rowspan='2'>BPJS</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='5%' rowspan='2'>Umum</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='5%' rowspan='2'>Jumlah</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='5%' rowspan='2'>Keterangan</td>"+
                "</tr>"+
                "<tr class='isi'>"+
                ...
                "</tr>" +
                "<tr class='isi'>"+
                    "<td valign='middle' style='font-weight: bold' align='center' colspan='14'>Rawat Inap</td>"+
                "</tr>"
            );
            //get data Ranap
                ...
                while(rs.next()){
                    ...
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' align='center'>"+(rs.getInt(3)+rs.getInt(4)+rs.getInt(5)+rs.getInt(6)+rs.getInt(7)+rs.getInt(8)+rs.getInt(9)+rs.getInt(10)+_bpjs+rs.getInt(12))+"</td>"+
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    "<td valign='middle' style='font-weight: bold' align='center' colspan='14'>Rawat Jalan</td>"+
                "</tr>"
            ); 
            //get data Ralan
            ...
            try {
                ...
                System.out.println("laporan.Yanmed10BesarPenyakit.prosesCari() : "+e);
            } finally{
                if(rs!=null){
                    rs.close();
                }
