...
public class DlgYanmedSIRSPembedahan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgYanmedSIRSPembedahan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan SIRS RL 3.6 Pembedahan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgYanmedSIRSPembedahan dialog = new DlgYanmedSIRSPembedahan(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='13%' >SPESIALISASI</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >TOTAL</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >KHUSUS</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >BESAR</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >SEDANG</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >KECIL</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >ELEKTIVE</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='1%' >EMERGENCY</td>"+
            ...
            ps=koneksi.prepareStatement(
                    "SELECT p.nm_poli, COUNT(o.no_rawat) AS jml,\n" +
                    ...
                    "SUM(CASE WHEN o.kategori = 'Elektive' THEN 1 ELSE 0 END) elektive,\n" +
                    "SUM(CASE WHEN o.kategori = 'Emergency' THEN 1 ELSE 0 END) emergency\n" +
                    "FROM reg_periksa r\n" +
                    "INNER JOIN operasi o ON o.no_rawat = r.no_rawat\n" +
...
//                    int jumlah = rs.getInt("l") + rs.getInt("p");
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' align='center'>"+rs.getString("elektive")+"</td>"+
                            "<td valign='middle' align='center'>"+rs.getString("emergency")+"</td>"+
