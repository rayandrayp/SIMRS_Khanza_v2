...
public class DlgYanmedSIRSObatPelayanan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgYanmedSIRSObatPelayanan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan SIRS RL 3.13b Obat Pelayanan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgYanmedSIRSObatPelayanan dialog = new DlgYanmedSIRSObatPelayanan(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='13%' >GOLONGAN OBAT</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='3%' >RAWAT JALAN</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='3%' >IGD</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='3%' >RAWAT INAP</td>"+
            ...
            ps=koneksi.prepareStatement(
                    "SELECT k.nama,\n" +
                    "SUM(CASE WHEN  rp.status_lanjut = 'Ralan' AND rp.kd_poli <> 'UGD' THEN 1 ELSE 0 END) rawat_jalan, \n" +
                    "SUM(CASE WHEN  rp.status_lanjut = 'Ralan' AND rp.kd_poli = 'UGD' THEN 1 ELSE 0 END) ugd,\n" +
                    "SUM(CASE WHEN  rp.status_lanjut = 'Ranap' THEN 1 ELSE 0 END) rawat_inap\n" +
                    "FROM detail_pemberian_obat dpo \n" +
                    "INNER JOIN reg_periksa rp ON rp.no_rawat = dpo.no_rawat\n" +
                    "INNER JOIN databarang d ON d.kode_brng = dpo.kode_brng\n" +
                    "INNER JOIN kategori_barang k ON k.kode = d.kode_kategori\n" +
                    "WHERE k.nama <> '-' AND rp.tgl_registrasi BETWEEN ? AND ?\n" +
                    "GROUP BY k.nama");
            try {
                i=1;                     
                ...
                while(rs.next()){
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' align='center'>"+rs.getString("nama")+"</td>"+
                            "<td valign='middle' align='center'>"+rs.getString("rawat_jalan")+"</td>"+
                            "<td valign='middle' align='center'>"+rs.getString("ugd")+"</td>"+
                            "<td valign='middle' align='center'>"+rs.getString("rawat_inap")+"</td>"+
