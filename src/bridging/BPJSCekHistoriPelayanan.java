...
public final class BPJSCekHistoriPelayanan extends javax.swing.JDialog {
    ...
    public BPJSCekHistoriPelayanan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.","Diagnosa","Jenis Pelayanan","Kelas Rawat","Nama Peserta","No.Kartu","No.SEP","No.Rujukan","Poli","PPK Pelayanan","Pulang SEP","Tgl.SEP", "Tgl. Kunjungan"};
                ...
                if(response.isArray()){
                    ...
                    for(JsonNode list:response){
                        tabMode.addRow(new Object[]{
                            ...
                            list.path("tglSep").asText(), tglKunjungan
                        });    
                        i++;
                    }
                }        
