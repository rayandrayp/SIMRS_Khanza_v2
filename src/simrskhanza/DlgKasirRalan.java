...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    public DlgKasirRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabModekasir=new DefaultTableModel(null,new String[]{
            ...
            "Jam","No.Reg","Status Bayar","Stts Poli","Kd PJ","Kd Poli","No.Telp Pasien", "Jenis Daftar", "Status Checkin"}){
    ...
    private void initComponents() {
        ...
        ppBerkasRM.setText("Berkas RM Yanmed");
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-02-2023" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-02-2023" }));
...
//        }
    ...
    private void MnCaseMixActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCaseMixActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data pasien sudah habis...!!!!");
            TNoRMCari.requestFocus();
        }else if(TPasienCari.getText().trim().equals("")){
            ...
            Map<String, Object> param = new HashMap<>();
            param.put("norawat",TNoRw.getText());
            Valid.MyReport("rptCaseMix.jasper","report","::[ Cetak Case Mix RJ ]::",param);      
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_MnCaseMixActionPerformed
    ...
    private void ppBerkasRMBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBerkasRMBtnPrintActionPerformed
        if(Sequel.cariInteger("select count(*) from laporan_berkasrm where no_rawat = '"+TNoRwCari.getText()+"'")==0){
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            YanmedBerkasRM lapberkasrm=new YanmedBerkasRM(null,false);
            lapberkasrm.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            lapberkasrm.setLocationRelativeTo(internalFrame1);
            lapberkasrm.setVisible(true);
            lapberkasrm.isCek();
            lapberkasrm.setNoRm(TNoRMCari.getText(),TNoRwCari.getText(),"RJ");
            this.setCursor(Cursor.getDefaultCursor());
        } else {
            JOptionPane.showMessageDialog(null,"No Rawat tersebut telah dibuatkan laporan..!!");
        }
...
//            semua = true;
            pskasir=koneksi.prepareStatement("SELECT a.no_reg,a.no_rawat,a.tgl_registrasi,a.jam_reg,a.kd_dokter,a.nm_dokter,a.no_rkm_medis,a.nm_pasien, " +
                ...
                "( " +
                    ...
                    "poliklinik.nm_poli,reg_periksa.p_jawab,reg_periksa.almt_pj,reg_periksa.hubunganpj,reg_periksa.biaya_reg,reg_periksa.stts,penjab.png_jawab, " +
                    "concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur, reg_periksa.status_bayar,reg_periksa.status_poli,reg_periksa.kd_pj,reg_periksa.kd_poli,pasien.no_tlp  " +
...
//                        || rskasir.getString("statuscheckin").toLowerCase().contains(CrPtg.getText().toLowerCase())  
                        ...
                        tabModekasir.addRow(new String[] {
                            ...
                            rskasir.getString("kd_pj"),rskasir.getString("kd_poli"),rskasir.getString("no_tlp"), jnsDaftar, rskasir.getString("statuscheckin")
                        });
                    }
                }                
            } catch(Exception e){
